...
export class SubgraphNFT extends ethereum.SmartContract {
  static bind(address: Address): SubgraphNFT {
    return new SubgraphNFT("SubgraphNFT", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get premintOwners(): Array<Address> {
